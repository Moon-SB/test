                    ...
                    <div class="property-listing-row" style="margin:250px; margin-top: 30px; margin-bottom: 30px;">
                        <div class="row align-items-center">
                            <div class="col-sm-5">
                                <a class="listing-thumb" href="#">
                                    <img src="images/chaeum1.png" alt="" class="img-fluid">
                     ...
                     <div class="property-listing-row" style="margin:250px; margin-top: 30px; margin-bottom: 30px;">
                        <div class="row align-items-center">
                            <div class="col-sm-5">
                                <a class="listing-thumb" href="#">
                                    <img src="images/wing.jpg" alt="" class="img-fluid">
                                    <span class="listing-label sale"></span>
                                </a>
                            </div>
                            <div class="col-sm-7">
                     ...
                     <div class="property-listing-row" style="margin:250px; margin-top: 30px; margin-bottom: 30px;">
                        <div class="row align-items-center">
                            <div class="col-sm-5">
                                <a class="listing-thumb" href="#">
                                    <img src="images/toz1.png" alt="" class="img-fluid">
                                    <span class="listing-label sale"></span>
                                </a>
                            </div>
                            <div class="col-sm-7">
                     ...
                     <div class="property-listing-row" style="margin:250px; margin-top: 30px; margin-bottom: 30px;">
                        <div class="row align-items-center">
                            <div class="col-sm-5">
                                <a class="listing-thumb" href="#">
                                    <img src="images/youngs1.png" alt="" class="img-fluid">
                                    <span class="listing-label sale"></span>
                                </a>
                            </div>
                            <div class="col-sm-7">
                      ...
                      <div class="property-listing-row" style="margin:250px; margin-top: 30px; margin-bottom: 30px;">
                        <div class="row align-items-center">
                            <div class="col-sm-5">
                                <a class="listing-thumb" href="#">
                                    <img src="images/jackson1.png" alt="" class="img-fluid">
                                    <span class="listing-label sale"></span>
                                </a>
                            </div>
                            <div class="col-sm-7">
