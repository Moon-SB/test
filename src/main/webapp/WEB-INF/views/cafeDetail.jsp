...
<body>
        ...
        <!-- ###################################################################### -->
          ...
          <div class="container pt100 pb70" style="margin-left: 50px;">
        <div class="row" style="width: 1400px;">
            <div class="col-lg-9 ml-auto mb30 sticky-content course-detail">
                ...
                <div style="position:relative;height:0;padding-bottom:40.25%">
                    <img alt="" src="images/chaeummain2.png" width="500px" height="400px">
                    <div style="position: relative; left: 550px; top: -400px;">
						...
						<button type="button" class="btn btn-outline-primary mb5" style="margin-top: 5px ">이용권 구매</button>
                    ...
                    <ul class="nav tab-list nav-justified">
                        ...
                        <li class="nav-item" role="presentation">
                         ...
                         <li class="nav-item" role="presentation">
                            <a data-toggle="tab" class="nav-link" href="#">
